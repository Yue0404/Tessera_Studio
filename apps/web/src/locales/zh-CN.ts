export const zhCN = {
  translation: {
    ...
    "action.clearCanvasConfirm": "确定清空所有可编辑内容吗？此操作可以撤销。",
    "action.create": "创建工程",
    "action.cancel": "取消",
    "action.close": "关闭",
    "action.back": "返回",
    "action.delete": "删除所选对象",
    "action.deleteObject": "删除此对象",
    "action.deleteSelection": "删除全部 {{count}} 个对象",
    "status.saved": "已保存",
    "status.saving": "正在保存",
    ...
    "catalog.objectPresetDirectory": "物体预设",
    "catalog.backToDirectory": "返回元素目录",
    "catalog.openObjectPresets": "打开物体预设",
    "catalog.objectPresetCount": "{{count}} 个可用预设",
    "catalog.activeSettings": "当前元素设置",
    "catalog.activeTool": "当前工具：{{tool}}",
    "catalog.cellSettings": "地格颜色设置",
    ...
    "catalog.noActiveSettings": "当前元素没有可调整的放置选项。",
    "catalog.moduleDefaultStyle": "使用模块默认样式，放置后选择对象编辑。",
    "catalog.module": "当前模块",
    "catalog.category": "分类",
    "catalog.category.all": "全部分类",
    "catalog.category.cell": "地格",
    "catalog.category.edge": "共享边",
    "catalog.category.object": "物体",
    ...
    "tool.edge": "边",
    "tool.eraser": "橡皮擦",
    "eraserQuick.title": "选择擦除方式",
    "eraserMode.click": "单击擦除",
    "eraserMode.drag": "滑动擦除",
    "eraserMode.clickShort": "单击",
    "eraserMode.dragShort": "滑动",
    "tool.select": "选择",
    "tool.pan": "平移",
    "tool.marker": "标记",
    "tool.object": "物体",
    "objectQuick.title": "选择物体",
    ...
    "inspector.selectionSummary": "所选对象摘要",
    "inspector.coordinate.cell": "行 {{row}}，列 {{column}}",
    "inspector.coordinate.point": "X {{x}}，Y {{y}}",
    "inspector.coordinate.group": "锚点 {{anchor}}，共 {{count}} 格",
    "inspector.summary.cell": "已修改地格",
    "inspector.summary.edge": "共享边样式",
    "inspector.summary.text": "空文字",
    "inspector.summary.marker": "{{shape}}标记",
    "inspector.summary.connection": "线段",
    "inspector.summary.arrow": "箭头",
    ...
    "markerQuick.title": "选择放置类型",
    "markerQuick.marker": "标记",
    "markerQuick.text": "文字",
    "markerQuick.label": "标记附文",
    "mapSettings.apply": "应用地图设置",
    "mapSettings.pendingApi": "等待地图模型更新接口接入",
    "mapSettings.error.size": "宽度和高度必须是 1–40000 的整数。",
    "mapSettings.error.width": "宽度必须是 1–40000 的整数。",
    "mapSettings.error.height": "高度必须是 1–40000 的整数。",
    "mapSettings.error.cellSize": "单元格尺寸必须是 12–96 的整数。",
    "mapSettings.error.rejected": "地图内容超出新边界，设置未应用。",
    ...
    "layer.tessera.basic.domain-object": "物体",
