...
- 核心静态网站仍面向 Windows 10+ 的支持矩阵内现代浏览器；仅可选 Civ6 提取器不承诺普通 Windows 10 22H2，正式支持目标为 Windows 11 24H2+ x64。提取器发布前仍须闭合精确目标系统实机证据，不能由 Windows Server 2022 CI 或其他 Windows 11 开发机构建替代。
