...
- VIEW-008、最大地图内存、跨块稳定、当前浏览器、Chrome/Firefox 前一主版本与无障碍自动/人工证据已闭合；PERF-010 已具备严格 CIM/Schema/固定场景、系统 Edge 与被测提交 provenance/release:ready 门禁，但参考机实跑、是否扩展多浏览器的决定及 Edge 前一主版本仍须闭合或明确延期。
