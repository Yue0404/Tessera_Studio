...
export const BASIC_ELEMENTS: readonly ModuleElementDefinition[] = Object.freeze(
  [
    ...
    },
    {
      ...
      nameKey: { kind: "key", key: "element.objectCircle.name" },
      descriptionKey: { kind: "key", key: "element.objectCircle.description" },
    ...
    },
    {
      ...
      categoryId: "tessera.basic:category.object",
      nameKey: { kind: "key", key: "element.objectSquare.name" },
      descriptionKey: {
        kind: "key",
        key: "element.objectSquare.description",
      },
      primitive: "domain-object",
      layerId: "tessera.basic.domain-object",
      anchors: ["cell"],
    ...
    },
    {
      ...
      categoryId: "tessera.basic:category.object",
      nameKey: { kind: "key", key: "element.objectHexCluster.name" },
      descriptionKey: {
        kind: "key",
        key: "element.objectHexCluster.description",
      },
      primitive: "domain-object",
      layerId: "tessera.basic.domain-object",
      anchors: ["cell"],
      ...
      group: {
        ...
        maxMembers: 7,
        connectivity: "edge",
        memberRules: ["connected", "center-and-six-neighbors"],
        placementPreset: {
          "hex-pointy": [
            { q: 0, r: 0 },
            { q: 1, r: 0 },
