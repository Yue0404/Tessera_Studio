...
export const BASIC_ELEMENTS: readonly ModuleElementDefinition[] = Object.freeze(
  [
    ...
    },
    {
      ...
      categoryId: "tessera.basic:category.object",
      nameKey: { kind: "key", key: "element.object.name" },
      descriptionKey: { kind: "key", key: "element.object.description" },
      ...
      defaultStyle: {
        ...
        style: { fillColor: "#D9B866CC", fillOpacity: 0.78 },
      },
      attributeSchema: emptyAttributes,
      occupancy: [],
      constraintIds: [],
...
export const BASIC_MODULE_MANIFEST: ModuleManifest = {
  ...
  layers: [
    ...
    {
      layerId: "tessera.basic.domain-object",
      nameKey: { kind: "key", key: "layer.domainObject" },
      zIndex: 3200,
